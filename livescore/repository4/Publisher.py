...
import random
import asyncio
from livescore import database,programmati,in_corso,terminati
...
#{ "sport" : "calcio", "squadre" : "k vs z" ,"punti":punti,"ammonizioni":ammonizioni,"interruzioni":interruzioni,"iniziata":True}
class Partita():
    partite=[programmati,in_corso,terminati]  # ogni volta devo mandare questo in websocket
...
async def main():
    partite_programmate = await programmati.find().to_list(length=None)
    print(partite_programmate)
