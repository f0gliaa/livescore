...
def crea_partite():
    ...
    for i in range(5):
        ...
        partita = {
            "id": id,
            "ora_inizio": ora_base + datetime.timedelta(seconds=20 * i), #ogni partita inizia ogni 20 secondi
...
async def inserisci_match(lista_match):    #inserisco i match nella collection "programmati"
...
async def main():
    ...
    print(lista_match)
    await inserisci_match(lista_match)
